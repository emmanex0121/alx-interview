...
Algorithm Python ALX INTERVIEW PREP
...
```
phoenix@phoenix-PC:~/0x04-utf8_validation$ cat 0-main.py
#!/usr/bin/python3
"""
...
phoenix@phoenix-PC:~/0x04-utf8_validation$

```

```
phoenix@phoenix-PC:~/0x04-utf8_validation$ ./0-main.py
True
True
False
phoenix@phoenix-PC:~/0x04-utf8_validation$
